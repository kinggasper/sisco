...
$pag->paginar("select * from cliente where organismo_id =" . $_GET['id'], 5);
$organismo = new organismo();
$organismo = $organismo->ver($_GET['id']);
$organismo = $organismo['data'][0];
// </editor-fold>
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="container">
            <div class="content">
                <div class="page-header">
                    <h1><?php echo $organismo['nombre']; ?> <small> Clientes registrados</small> </h1>
                </div>
                <ul class="breadcrumb">
                ...
                <div class="row">
                    <div class="span16">
                                ...
                                <tbody>
                                    <?php foreach ($pag->registros as $registro): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../cliente/modificar.php?id=<?php echo $registro['id']; ?>" class="btn small info">Modificar</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        ...
                        <?php endif; ?>
                        <div class="actions">
                            <a href="crear.php" class="btn small primary">Crear organismo</a>
