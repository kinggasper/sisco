...
if (isset($_GET['filtrar'])) {
    $query.=" where categoria.nombre like '%{$_GET['filtrar']}%'";
}
$pag->paginar($query, 5);
// </editor-fold>
?>
        ...
        <div class="container">
            <div class="content">
                <div class="page-header">
                    <h1>Listar Categorias <small> Categorias disponibles</small> </h1>
                </div>
                <ul class="breadcrumb">
                    <li><a href="../usuario">Sistema</a><span class="divider">&raquo;</span></li>
                    <li><a href="listar.php">categoria</a><span class="divider">&raquo;</span></li>
                    <li>Listar</li>
                </ul>
                <div class="row">
                    <div class="span16">
                        <?php if (count($pag->registros) > 0): ?>
                            <div class="pull-right">
                                <form class="">
                                    <label>Filtrar</label>
                                    <div class="input">
                                        <input type="search" name="filtrar" id="filtrar" placeholder="Buscar categoria" value="<?php echo isset($_GET['filtrar']) ? $_GET['filtrar'] : ""; ?>" />
                                    </div>
                                </form>
                            </div>
                        ...
                        <?php endif; ?>
                        <div class="actions">
                            <a href="crear.php" class="btn small primary">Crear Categoria</a>
                            <a href="../usuario" class="btn small ">Volver al menu</a>
                        </div>
                    </div>
                    <div class="hide">
                        <h3>Ayuda</h3>
                        <p>Listado de categorias que emiten contratos</p>
                    </div>
                </div>
                <footer class="footer">
                    <div class="container">
