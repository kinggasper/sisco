        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#archivo").rules('add',{
                    ...
                    accept:"txt|csv",
                    messages:{
                        required:"Por favor agregue un archivo de carga.",
                        accept:" Formato de archivo invalido."
                    }
                });
            });
        </script>
            ...
            <div class="content">
                ...
                <?php if (isset($_POST['enviar']) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>Archivo de respuesta cargado con <strong>&Eacute;xito.</strong></p>
                ...
                <?php else: ?>
                    <?php if (isset($_POST['submit']) && isset($resultado['suceed']) && !$resultado['suceed']): ?>
                        <div class="alert-message block-message error">
                            <a class="close" href="#">×</a>
                            <p>Ha ocurrido un error al cargar el archivo.</p>
                            <?php if (DEBUG): ?>
                ...
                <div class="row">
                    <div class="span16">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <fieldset>
                                <div class="actions">
                                    <input type="submit" class="btn primary" name="enviar" value="Procesar"/>
