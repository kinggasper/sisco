...
$pag->paginar("select * from vendedor where empresa_id =" . $_GET['id'], 5);
// </editor-fold>
?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="span16">
                                ...
                                <tbody>
                                    <?php foreach ($pag->registros as $registro): ?>
                                        <tr>
                                            ...
                                            <td><?php echo misc::trim_text($registro['direccion'], 120); ?></td>
                                            <td>
                                                <a href="../vendedor/modificar.php?id=<?php echo $registro['id']; ?>" class="btn small info">Modificar</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                        ...
                        <?php endif; ?>
                        <div class="actions">
                            <a href="../vendedor/crear.php" class="btn small primary">Crear Vendedor</a>
