            ...
            <div class="content">
                ...
                <?php if (isset($_POST) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>Empresa editada con <strong>&Eacute;xito.</strong></p>
                ...
                <div class="alert-message block-message error">
                        <a class="close" href="#">×</a>
                        <p>Ha ocurrido un error al modificar la empresa.</p>
                        <?php if(DEBUG):?>
                ...
                <?php endif; ?>
                    <div class="row">
                        <div class="hide">
                            <h3>Ayuda</h3>
                            <p>Ingrese los datos para modificar una Empresa</p>
                        </div>
                        <div class="span16">
                                ...
                                <form method="post" action="">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="input">
                                                <input type="text" class="required" name="rif" id="rif" value="<?php echo $dato['Rif'] ?>"/>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="numero_cuenta">N&uacute;mero de cuenta:</label>
                                            <div class="input">
                                                <input type="text" class="required" name="numero_cuenta" id="numero_cuenta" value="<?php echo $dato['Numero_cuenta'] ?>"/>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
