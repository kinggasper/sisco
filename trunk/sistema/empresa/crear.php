            ...
            <div class="content">
                ...
                <?php if (isset($_POST) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>Empresa creada con <strong>&Eacute;xito.</strong></p>
                ...
                <div class="alert-message block-message error">
                        <a class="close" href="#">×</a>
                        <p>Ha ocurrido un error al registrar la empresa.</p>
                        <?php if(DEBUG):?>
                ...
                <?php endif; ?>
                    <div class="row">
                        <div class="hide">
                            <h3>Ayuda</h3>
                            <p>Ingrese los datos para crear una Empresa</p>
                        </div>
                        <div class="span16">
                            <form method="post" action="">
                                <fieldset>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="input">
                                            <input class="required" type="text" name="rif" id="rif"/>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                        <label for="numero_cuenta">N&uacute;mero de cuenta:</label>
                                        <div class="input">
                                            <input type="text" name="numero_cuenta" id="numero_cuenta" class="required"/>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
