...
if (isset($_POST['submit'])) {
    $data = $_POST;
    unset($data['submit']);
    $resultado = $cliente->actualizar($_POST['id'], $data);
} elseif (isset($_GET['id'])) {
    $registro = $cliente->ver($_GET['id']);
}
// </editor-fold>
?>
<!DOCTYPE html>
            ...
            <div class="content">
                ...
                <?php if (isset($_POST) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>cliente editado con <strong>&Eacute;xito.</strong></p>
                ...
                <div class="alert-message block-message error">
                        <a class="close" href="#">×</a>
                        <p>Ha ocurrido un error al modificar el cliente.</p>
                        <?php if(DEBUG):?>
                ...
                <?php endif; ?>
                    <div class="row">
                        <div class="hide">
                            <h3>Ayuda</h3>
                            <p>Ingrese los datos para modificar un cliente</p>
                        </div>
                        <div class="span16">
                                ...
                                <form method="post" action="">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="input">
                                                <input class="required" type="text" name="apellido" id="apellido" value="<?php echo $dato['Apellido']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="nacionalidad">nacionalidad:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required mini" type="text" name="nacionalidad" id="nacionalidad" value="<?php echo $dato['nacionalidad']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="cedula">cedula:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required digits" type="text" name="cedula" id="cedula" value="<?php echo $dato['cedula']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="email">email:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required email" type="text" name="email" id="email" value="<?php echo $dato['email']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="telefono_local">telefono local:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required digits" type="text" name="telefono_local" id="telefono_local" value="<?php echo $dato['telefono_local']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="telefono_trabajo">telefono trabajo:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required digits" type="text" name="telefono_trabajo" id="telefono_trabajo" value="<?php echo $dato['telefono_trabajo']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="direccion">direccion:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required" type="text" name="direccion" id="direccion" value="<?php echo $dato['Direccion']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="cargo">cargo:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required" type="text" name="cargo" id="cargo" value="<?php echo $dato['Cargo']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="departamento">departamento:<sup>*</sup></label>
                                            <div class="input">
                                                <input class="required" type="text" name="departamento" id="departamento" value="<?php echo $dato['Departamento']; ?>"/> 
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="organismo">organismo:<sup>*</sup></label>
                                            <div class="input">
                                                <input readonly="true" class="required" type="text" name="organismo" id="organismo" value="<?php echo $dato['organismo']; ?>"/> 
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
