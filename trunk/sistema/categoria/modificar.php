...
if (isset($_POST['submit'])) {
    $data = $_POST;
    unset($data['submit']);
    $resultado = $categoria->actualizar($_POST['id'], $data);
} elseif (isset($_GET['id'])) {
    $registro = $categoria->ver($_GET['id']);
}
// </editor-fold>
?>
<!DOCTYPE html>
            ...
            <div class="content">
                ...
                <?php if (isset($_POST) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>Categoria editada con <strong>&Eacute;xito.</strong></p>
                ...
                <div class="alert-message block-message error">
                        <a class="close" href="#">×</a>
                        <p>Ha ocurrido un error al modificar la categoria.</p>
                        <?php if(DEBUG):?>
                ...
                <?php endif; ?>
                    <div class="row">
                        <div class="hide">
                            <h3>Ayuda</h3>
                            <p>Ingrese los datos para modificar un categoria</p>
                        </div>
                        <div class="span16">
