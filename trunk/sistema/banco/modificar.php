...
if (isset($_POST['submit'])) {
    $data = $_POST;
    unset($data['submit']);
    $resultado = $banco->actualizar($_POST['id'], $data);
} elseif (isset($_GET['id'])) {
    $registro = $banco->ver($_GET['id']);
}
// </editor-fold>
?>
<!DOCTYPE html>
            ...
            <div class="content">
                ...
                <?php if (isset($_POST) && $resultado['suceed'] == true): ?>
                    <div class="alert-message block-message success">
                        ...
                        <p>banco editado con <strong>&Eacute;xito.</strong></p>
                ...
                <div class="alert-message block-message error">
                        <a class="close" href="#">×</a>
                        <p>Ha ocurrido un error al modificar el banco.</p>
                        <?php if(DEBUG):?>
                        ...
                        <div class="span16">
                            <?php if ($registro['suceed'] && count($registro['data']) > 0): ?>
                                <form method="post" action="">
                                    ...
                                    <fieldset>
                                        <legend>Datos de la banco</legend>
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="input">
                                                <input type="text" class="required" name="codigo" id="codigo" value="<?php echo $dato['codigo'] ?>"/>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                            <label for="web">web:</label>
                                            <div class="input">
                                                <input type="text" class="required" name="web" id="web" value="<?php echo $dato['web'] ?>"/>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
